...
import { AppleContactsQueueService } from "./apple-contacts-queue.service";
import { AppleContactsQueueProcessor } from "./apple-contacts-queue.processor";
import {
...
@Module({
  ...
  providers: [
    ...(isRedisConfigured
      ? [AppleContactsQueueService, AppleContactsQueueProcessor]
      : []),
    ContactsImportService,
    ContactsProviderTokensService,
  ],
  exports: [
    ...(isRedisConfigured ? [AppleContactsQueueService] : []),
    ContactsImportService,
    ContactsProviderTokensService,
  ],
})
export class AppleContactsQueueModule {}
