...
import { MicrosoftContactsQueueService } from "./microsoft-contacts-queue.service";
import { MicrosoftContactsQueueProcessor } from "./microsoft-contacts-queue.processor";
import {
...
@Module({
  ...
  providers: [
    ...(isRedisConfigured
      ? [MicrosoftContactsQueueService, MicrosoftContactsQueueProcessor]
      : []),
    ContactsImportService,
    ContactsProviderTokensService,
  ],
  exports: [
    ...(isRedisConfigured ? [MicrosoftContactsQueueService] : []),
    ContactsImportService,
    ContactsProviderTokensService,
  ],
})
export class MicrosoftContactsQueueModule {}
