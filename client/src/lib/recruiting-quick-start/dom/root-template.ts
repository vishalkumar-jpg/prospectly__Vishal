...
<div id="qsPanel">
  <div class="qs-head">
    ...
    <p>Start an interactive tour of the product</p>
...
<div id="qsdBack"></div>
<div id="qsdWin">
  <div class="qsd-tab" id="qsdTab">Post a Job</div>
  <div class="qsd-frame">
    <div class="qsd-stage" id="qsdStage"></div>
    <div class="qsd-bar">
      <span class="gnum" id="qsdStep">1/8</span>
      <div class="gtxt"><h5 id="qsdT"></h5><p id="qsdD"></p></div>
      <button class="gback" id="qsdPrev"><span class="garr" aria-hidden="true">←</span> Back</button>
      <button class="gnext" id="qsdNext">Next <span class="garr" aria-hidden="true">→</span></button>
