import { IC as baseIC, svgIc } from "../recruiting-quick-start/icons";
...
const extra = {
  ...
  idCard: svgIc(
    '<path d="M16 10h2"/><path d="M16 14h2"/><path d="M6.17 15a3 3 0 0 1 5.66 0"/><circle cx="9" cy="11" r="2"/><rect width="20" height="14" x="2" y="5" rx="2"/>'
  ),
  landmark: svgIc(
  ...
  arrowRight: svgIc('<path d="M5 12h14"/><path d="m12 5 7 7-7 7"/>', 14, 14),
  atSign: svgIc(
  ...
  arrowLeft: svgIc('<path d="m12 19-7-7 7-7"/><path d="M19 12H5"/>', 14, 14),
  handshake: svgIc(
